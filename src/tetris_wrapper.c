...
static int __pyx_pw_6tetris_8PyTetris_1__cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("__cinit__ (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_C)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("__cinit__", 1, 3, 3, 1); __PYX_ERR(1, 7, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_FR)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("__cinit__", 1, 3, 3, 2); __PYX_ERR(1, 7, __pyx_L3_error)
        }
      }
    ...
    __pyx_v_R = __Pyx_PyInt_As_int(values[0]); if (unlikely((__pyx_v_R == (int)-1) && PyErr_Occurred())) __PYX_ERR(1, 7, __pyx_L3_error)
    __pyx_v_C = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_C == (int)-1) && PyErr_Occurred())) __PYX_ERR(1, 7, __pyx_L3_error)
    __pyx_v_FR = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_FR == (int)-1) && PyErr_Occurred())) __PYX_ERR(1, 7, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("__cinit__", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(1, 7, __pyx_L3_error)
  __pyx_L3_error:;
 ...
 *         self.c_action.rot = 0             # <<<<<<<<<<<<<<
 * 
 *     def get_state(self, int move, int rot):
 */
  ...
  __Pyx_RefNannySetupContext("get_state (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_rot)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("get_state", 1, 2, 2, 1); __PYX_ERR(1, 12, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "get_state") < 0)) __PYX_ERR(1, 12, __pyx_L3_error)
      }
    ...
    __pyx_v_move = __Pyx_PyInt_As_int(values[0]); if (unlikely((__pyx_v_move == (int)-1) && PyErr_Occurred())) __PYX_ERR(1, 12, __pyx_L3_error)
    __pyx_v_rot = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_rot == (int)-1) && PyErr_Occurred())) __PYX_ERR(1, 12, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("get_state", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(1, 12, __pyx_L3_error)
  __pyx_L3_error:;
 ...
 *         self.c_action.move = move             # <<<<<<<<<<<<<<
 *         self.c_action.rot = rot
 *         cdef int[::1] view = <int[:self.c_tetris.r * self.c_tetris.c]> self.c_tetris.get_state(self.c_action)
 */
 ...
 */
  ...
  __pyx_t_3 = Py_BuildValue((char*) "("  __PYX_BUILD_PY_SSIZE_T  ")", ((Py_ssize_t)(__pyx_v_self->c_tetris.r * __pyx_v_self->c_tetris.c)));
  if (unlikely(!__pyx_t_4 || !__pyx_t_3 || !PyBytes_AsString(__pyx_t_4))) __PYX_ERR(1, 15, __pyx_L1_error)
  ...
  __pyx_t_5 = __Pyx_PyObject_to_MemoryviewSlice_dc_int(((PyObject *)__pyx_t_2), PyBUF_WRITABLE); if (unlikely(!__pyx_t_5.memview)) __PYX_ERR(1, 15, __pyx_L1_error)
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_6 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_asarray); if (unlikely(!__pyx_t_6)) __PYX_ERR(1, 17, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __pyx_memoryview_fromslice(__pyx_v_view, 1, (PyObject *(*)(char *)) __pyx_memview_get_int, (int (*)(char *, PyObject *)) __pyx_memview_set_int, 0);; if (unlikely(!__pyx_t_3)) __PYX_ERR(1, 17, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_7 = NULL;
...
static int __Pyx_modinit_type_init_code(void) {
  ...
  /*--- Type init code ---*/
  if (PyType_Ready(&__pyx_type_6tetris_PyTetris) < 0) __PYX_ERR(1, 4, __pyx_L1_error)
  #if PY_VERSION_HEX < 0x030800B1
  ...
  if (PyObject_SetAttr(__pyx_m, __pyx_n_s_PyTetris, (PyObject *)&__pyx_type_6tetris_PyTetris) < 0) __PYX_ERR(1, 4, __pyx_L1_error)
  if (__Pyx_setup_reduce((PyObject*)&__pyx_type_6tetris_PyTetris) < 0) __PYX_ERR(1, 4, __pyx_L1_error)
